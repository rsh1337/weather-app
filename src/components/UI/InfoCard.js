...
function Panel({index, latitude, longitude}) {
	...
	if (error) {
		return(
			<div
				className={
					'absolute drop-shadow-sm -top-16 overflow-y-auto translate-x-2 md:translate-x-80 -ml-2 md:ml-3 backdrop-opacity-80 bg-[#E2EAFC]/95 md:bg-[#E2EAFC]/80 z-30 rounded-xl w-full'
				}
			>
